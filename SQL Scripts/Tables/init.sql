...
--   tipo:      Oracle Database 12c
 ...
 CREATE TABLE ARTICLES
   (
      ...
      state_id      NUMBER DEFAULT ON NULL 1 NOT NULL
   ) ;

ALTER TABLE ARTICLES ADD CONSTRAINT ARTICLES_CODE_UNQ UNIQUE (code);
...
INVENTORY_MOV_SOURCE_id ) ;
 ...
 CREATE TABLE ORDERS
   (
      ...
      request_time  TIMESTAMP DEFAULT ON NULL SYSTIMESTAMP  NOT NULL ,
...
;
 ...
 CREATE TABLE USERS
   (
      ...
      creation_date TIMESTAMP DEFAULT ON NULL SYSTIMESTAMP  NOT NULL ,
